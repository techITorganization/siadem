            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="datajabatan.php">
                                <i class="far fa-check-square"></i>Data Bidang Pelayanan</a>
                        </li>
                        <li>
                            <a href="data_absen.php">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                             ...
                             <form class="form-header" action="prospenkar.php" method="POST">
                                <input class="au-input au-input--xl" autocomplete="off" type="text" name="cari" placeholder="Cari ID atau nama pelayan" />
                            ...
                            <form action="dt_karyawan_sv.php" enctype="multipart/form-data" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Tanggal Lahir</td>
                                                <td><input type="date" class="form-control" required="" name="tmp_tgl_lahir" autocomplete="off"></td>
                                            </tr>
                                            <tr>
                                                <td>Jenis Kelamin</td>
                                                <td>
